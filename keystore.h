...
#ifndef HEPTAFRANC_KEYSTORE_H
#define HEPTAFRANC_KEYSTORE_H
...
public:
    ...
    //! Support for BIP 0013 : see https://github.com/heptafranc/bips/blob/master/bip-0013.mediawiki
