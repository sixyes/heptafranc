...
{
    BOOST_CHECK(TestSplitHost("www.heptafranccore.org", "www.heptafranccore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.heptafranccore.org]", "www.heptafranccore.org", -1));
    BOOST_CHECK(TestSplitHost("www.heptafranccore.org:80", "www.heptafranccore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.heptafranccore.org]:80", "www.heptafranccore.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:10784", "127.0.0.1", 10784));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:10784", "127.0.0.1", 10784));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:10784", "::ffff:127.0.0.1", 10784));
    BOOST_CHECK(TestSplitHost("[::]:10784", "::", 10784));
    BOOST_CHECK(TestSplitHost("::10784", "::10784", -1));
    BOOST_CHECK(TestSplitHost(":10784", "", 10784));
    BOOST_CHECK(TestSplitHost("[]:10784", "", 10784));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:10784", "127.0.0.1:10784"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:10784", "[::]:10784"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
