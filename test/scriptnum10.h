...
#ifndef HEPTAFRANC_TEST_SCRIPTNUM10_H
#define HEPTAFRANC_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from HeptaFranc Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // HEPTAFRANC_TEST_BIGNUM_H
