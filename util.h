 ...
 */
#ifndef HEPTAFRANC_UTIL_H
#define HEPTAFRANC_UTIL_H
...
extern const char * const HEPTAFRANC_CONF_FILENAME;
extern const char * const HEPTAFRANC_PID_FILENAME;
...
{
    std::string s = strprintf("heptafranc-%s", name);
