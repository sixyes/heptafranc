...
#ifndef HEPTAFRANC_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define HEPTAFRANC_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // HEPTAFRANC_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
