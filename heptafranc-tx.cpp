...
static void SetupHeptaFrancTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " heptafranc-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  heptafranc-tx [options] <hex-tx> [commands]  Update hex-encoded heptafranc transaction\n" +
            "or:     heptafranc-tx [options] -create [commands]   Create hex-encoded heptafranc transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded heptafranc transaction
