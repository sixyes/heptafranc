...
#ifndef HEPTAFRANC_INTERFACES_NODE_H
#define HEPTAFRANC_INTERFACES_NODE_H
...
//! Top-level interface for a heptafranc node (heptafrancd process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // HEPTAFRANC_INTERFACES_NODE_H
