...
#ifndef HEPTAFRANC_WALLET_WALLET_H
#define HEPTAFRANC_WALLET_WALLET_H
...
public:
     ...
     * on this heptafranc node, and set to 0 for transactions that were created
...
#endif // HEPTAFRANC_WALLET_WALLET_H
