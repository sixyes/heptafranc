...
#ifndef HEPTAFRANC_QT_HEPTAFRANCUNITS_H
#define HEPTAFRANC_QT_HEPTAFRANCUNITS_H
...
/** HeptaFranc unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class HeptaFrancUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit HeptaFrancUnits(QObject *parent);

    /** HeptaFranc units.
      @note Source: https://en.heptafranc.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        HPTF,
...
typedef HeptaFrancUnits::Unit HeptaFrancUnit;

#endif // HEPTAFRANC_QT_HEPTAFRANCUNITS_H
