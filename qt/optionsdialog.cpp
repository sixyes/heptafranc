    ...
    mapper(0)
{
    ...
    ui->heptafrancAtStartup->setToolTip(ui->heptafrancAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->heptafrancAtStartup->setText(ui->heptafrancAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openHeptaFrancConfButton->setToolTip(ui->openHeptaFrancConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new HeptaFrancUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->heptafrancAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openHeptaFrancConfButton_clicked()
{
