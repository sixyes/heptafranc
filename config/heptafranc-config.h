/* src/config/heptafranc-config.h.  Generated from heptafranc-config.h.in by configure.  */
/* src/config/heptafranc-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef HEPTAFRANC_CONFIG_H

#define HEPTAFRANC_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The HeptaFranc Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "HeptaFranc Core"
...
#define PACKAGE_BUGREPORT "https://github.com/heptafranc/heptafranc/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "HeptaFranc Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "HeptaFranc Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "heptafranc"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://heptafranccore.org/"
